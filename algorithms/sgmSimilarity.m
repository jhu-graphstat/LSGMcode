function [ corr, corr_c ] = sgmSimilarity(A,B,seeds,topK, start, similarity, similarityWeight, roundGrad)
...
while (toggle==1)&&(iter<patience)
    ...
    Grad=(1-similarityWeight)*(A22*P*B22'+y+z+zz) + similarityWeight*similarity;
    ...
    w=A22'*T*B22;
    c=(1-similarityWeight)*trace(y*P');
    d=(1-similarityWeight)*trace(w*P')+trace(y*T');
    e=(1-similarityWeight)*trace(w*T');
    u=(1-similarityWeight)*trace(P'*z+P'*zz) + similarityWeight*trace(similarity*P);
    v=(1-similarityWeight)*trace(T'*z+T'*zz) + similarityWeight*trace(similarity*T);
